...
@Component({
  selector: 'app-create-multi-random',
  templateUrl: './create-multi-random.component.html',
  styleUrls: ['./create-multi-random.component.css'],
})
export class CreateMultiRandomComponent implements OnInit {
  ...
  onSubmit(): void {
    if (this.isFormValid()) {
      ...
      this.assessmentService.createMultiBankCombinedAssessment(formData).subscribe(
        (response: any) => {
